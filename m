...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 09B521330B9
	for <lists+dmaengine@lfdr.de>; Tue,  7 Jan 2020 21:41:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727184AbgAGUlt (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Tue, 7 Jan 2020 15:41:49 -0500
Received: from mga14.intel.com ([192.55.52.115]:55145 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726111AbgAGUlt (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Tue, 7 Jan 2020 15:41:49 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 07 Jan 2020 12:41:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,407,1571727600"; 
   d="scan'208";a="395510894"
Received: from djiang5-desk3.ch.intel.com ([143.182.136.137])
  by orsmga005.jf.intel.com with ESMTP; 07 Jan 2020 12:41:47 -0800
Subject: [PATCH v4 9/9] dmaengine: idxd: add char driver to expose
...
Date:   Tue, 07 Jan 2020 13:41:47 -0700
Message-ID: <157842970723.27241.5792057189271930671.stgit@djiang5-desk3.ch.intel.com>
...
index d02cc98bc6db..dae76319e9ec 100644
--- a/drivers/dma/idxd/device.c
+++ b/drivers/dma/idxd/device.c
@@ -533,7 +533,7 @@ static int idxd_wq_config_write(struct idxd_wq *wq)
...
index 7e2f1f6f8854..6792d2a6ce74 100644
...
@@ -140,6 +150,7 @@ struct idxd_device {
...
@@ -270,4 +300,11 @@ void idxd_parse_completion_status(u8 status, enum dmaengine_tx_result *res);
...
index 4ac95b011d04..60a6db8d1de5 100644
...
index 33394dd0af72..03a1e43fa674 100644
...
index 031e4a9e8f10..98faf02d224c 100644
--- a/drivers/dma/idxd/submit.c
+++ b/drivers/dma/idxd/submit.c
@@ -71,17 +71,19 @@ int idxd_submit_desc(struct idxd_wq *wq, struct idxd_desc *desc)
 {
 	struct idxd_device *idxd = wq->idxd;
