...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A286210C77A
	for <lists+dmaengine@lfdr.de>; Thu, 28 Nov 2019 12:01:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727285AbfK1LAw (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Thu, 28 Nov 2019 06:00:52 -0500
Received: from lelv0142.ext.ti.com ([198.47.23.249]:34510 "EHLO
        lelv0142.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727328AbfK1LAv (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Thu, 28 Nov 2019 06:00:51 -0500
Received: from fllv0034.itg.ti.com ([10.64.40.246])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id xASB0b58022909;
        Thu, 28 Nov 2019 05:00:37 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1574938837;
        bh=dy3a6UUfbYZOTI+GZHjtJGCYufj0OvEdtYF0iecFj+8=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=Gwi0sN5j7BkBrLHm9S3QtwUJNDqngi7CW3oPYy1J8zlX8EOh5gLCKY8/xSwmsM4CW
         CmPJUyMIYPzJuaNB4BMTgOZnP3h01ReQcnFf9T3wUorLf9mGBiTLK1OacI6xOOfZvs
         QzEZhGRAKXXaRq0huOfo8QVO0EUGuv6aPh8lz8Zg=
Received: from DFLE100.ent.ti.com (dfle100.ent.ti.com [10.64.6.21])
        by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id xASB0b9T046633
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Thu, 28 Nov 2019 05:00:37 -0600
Received: from DFLE115.ent.ti.com (10.64.6.36) by DFLE100.ent.ti.com
 (10.64.6.21) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3; Thu, 28
 Nov 2019 05:00:36 -0600
Received: from lelv0326.itg.ti.com (10.180.67.84) by DFLE115.ent.ti.com
 (10.64.6.36) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3 via
 Frontend Transport; Thu, 28 Nov 2019 05:00:36 -0600
Received: from feketebors.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by lelv0326.itg.ti.com (8.15.2/8.15.2) with ESMTP id xASAxgJT073287;
...
Subject: [PATCH v6 15/17] dmaengine: ti: k3-udma: Add glue layer for non DMAengine users
Date:   Thu, 28 Nov 2019 12:59:43 +0200
Message-ID: <20191128105945.13071-16-peter.ujfalusi@ti.com>
...
index a096f0ec3998..e41639e44d19 100644
...
index 0de79eacb278..c1450b0a8224 100644
--- a/drivers/dma/ti/k3-udma.c
+++ b/drivers/dma/ti/k3-udma.c
@@ -1048,6 +1048,64 @@ static irqreturn_t udma_udma_irq_handler(int irq, void *data)
 	return IRQ_HANDLED;
 }
...
+
 ...
 {
 	/*
@@ -2908,7 +2966,7 @@ static struct udma_match_data am654_main_data = {
...
+	.enable_memcpy_support = true, /* TEST: DMA domains */
 	...
 	.tpl_levels = 2,
@@ -3330,6 +3388,9 @@ static struct platform_driver udma_driver = {
