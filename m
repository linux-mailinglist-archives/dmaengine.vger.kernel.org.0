...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EBC0876A2CF
	for <lists+dmaengine@lfdr.de>; Mon, 31 Jul 2023 23:31:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231249AbjGaVbk (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Mon, 31 Jul 2023 17:31:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44896 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231467AbjGaVbK (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Mon, 31 Jul 2023 17:31:10 -0400
Received: from mgamail.intel.com (unknown [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4DAE21FDF;
        Mon, 31 Jul 2023 14:30:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1690839030; x=1722375030;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=J6e8zbtDi22LBlJd6/HBzI7J5yisp0j7TwSqLBWlGg4=;
  b=ZXyQikcWIa4p1o/ScFaF1PITgJ1R3bHXjL0yOqgARPmBw3U4JQ2Mk12e
   W1XYfAnkD9w6WtVo6uuZBOaSS/0VKJp7sqYpYNOb9ZQ7IP2F8XxTpf8vO
   pm8AvytUmsID4qzXqoojZZl6VD1UPaMr4/kcdJ3JAmY+pWvRz1/kyjCsI
   3z/C3EPl1bhgNvPPYfsgEksRuRFnZeQ8BszP7OJwcQ9UBT23MraQVm1un
   KvfImvAFWOQSi0U9aeV40v9/SrtI5VZ2NSzsYh3XUPYxJ6IEIyNc2/zsp
   h9OtV2SXgO8+fvEv4koFVKN56do8Ljl8teNNueidiKvG80ZFhcWpwfWnM
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10788"; a="349425982"
X-IronPort-AV: E=Sophos;i="6.01,245,1684825200"; 
   d="scan'208";a="349425982"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 31 Jul 2023 14:30:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10788"; a="728428868"
X-IronPort-AV: E=Sophos;i="6.01,245,1684825200"; 
   d="scan'208";a="728428868"
Received: from sgimmeke-mobl.amr.corp.intel.com (HELO tzanussi-mobl1.intel.com) ([10.212.91.213])
  by orsmga002-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 31 Jul 2023 14:30:12 -0700
...
Subject: [PATCH v8 12/14] crypto: iaa - Add support for deflate-iaa compression algorithm
Date:   Mon, 31 Jul 2023 16:29:37 -0500
Message-Id: <20230731212939.1391453-13-tom.zanussi@linux.intel.com>
...
---
 ...
 drivers/crypto/intel/iaa/iaa_crypto_main.c | 993 ++++++++++++++++++++-
 3 files changed, 1021 insertions(+), 18 deletions(-)
...
index 0c59332456f0..75c4846cb4ff 100644
...
@@ -29,9 +32,25 @@ static unsigned int nr_cpus_per_node;
...
+
 ...
 {
 	struct wq_table_entry *entry = per_cpu_ptr(wq_table, cpu);
@@ -66,6 +85,40 @@ static void wq_table_clear_entry(int cpu)
...
@@ -250,6 +303,12 @@ int add_iaa_compression_mode(const char *name,
 }
...
+
 ...
 {
@@ -268,6 +327,86 @@ static void free_device_compression_mode(struct iaa_device *iaa_device,
 	kfree(device_mode);
 }
...
@@ -300,6 +439,14 @@ static int init_device_compression_mode(struct iaa_device *iaa_device,
...
+
 	if (mode->init) {
 		...
 		if (ret)
@@ -372,18 +519,6 @@ static struct iaa_device *iaa_device_alloc(void)
 	return iaa_device;
 }
...
@@ -426,12 +561,8 @@ static int init_iaa_device(struct iaa_device *iaa_device, struct iaa_wq *iaa_wq)
...
@@ -497,6 +628,82 @@ static void clear_wq_table(void)
...
+
 ...
 {
 	int cpu;
@@ -580,6 +787,7 @@ static int save_iaa_wq(struct idxd_wq *wq)
...
@@ -587,6 +795,7 @@ static int save_iaa_wq(struct idxd_wq *wq)
 		if (ret) {
...
@@ -724,6 +933,678 @@ static void rebalance_wq_table(void)
 	}
 }
...
@@ -741,6 +1622,11 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
@@ -774,12 +1660,28 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
+	free_iaa_wq(idxd_wq_get_private(wq));
 err_save:
 	if (first_wq)
 		free_wq_table();
@@ -795,6 +1697,9 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
@@ -802,11 +1707,37 @@ static void iaa_crypto_remove(struct idxd_dev *idxd_dev)
 	mutex_lock(&iaa_devices_lock);
...
+	}
 	...
 	mutex_unlock(&iaa_devices_lock);
 	mutex_unlock(&wq->wq_lock);
@@ -832,10 +1763,19 @@ static int __init iaa_crypto_init_module(void)
...
@@ -844,20 +1784,37 @@ static int __init iaa_crypto_init_module(void)
 		goto err_driver_reg;
 	}
