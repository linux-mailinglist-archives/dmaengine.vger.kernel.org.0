...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9673E123AE4
	for <lists+dmaengine@lfdr.de>; Wed, 18 Dec 2019 00:34:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726387AbfLQXeH (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Tue, 17 Dec 2019 18:34:07 -0500
Received: from mga06.intel.com ([134.134.136.31]:17527 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726690AbfLQXeH (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Tue, 17 Dec 2019 18:34:07 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 17 Dec 2019 15:34:06 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,327,1571727600"; 
   d="scan'208";a="221872731"
Received: from djiang5-desk3.ch.intel.com ([143.182.136.137])
  by fmsmga001.fm.intel.com with ESMTP; 17 Dec 2019 15:34:05 -0800
Subject: [PATCH RFC v3 11/14] dmaengine: idxd: connect idxd to dmaengine
 subsystem
...
Date:   Tue, 17 Dec 2019 16:34:05 -0700
Message-ID: <157662564577.51652.4355401999411794837.stgit@djiang5-desk3.ch.intel.com>
...
index 1e24d7b44fdb..002ccfeda22b 100644
--- a/drivers/dma/Kconfig
+++ b/drivers/dma/Kconfig
@@ -283,6 +283,7 @@ config INTEL_IDXD
...
index 076456357962..fc1634e689cf 100644
...
@@ -168,6 +170,8 @@ struct idxd_device {
...
@@ -253,4 +258,13 @@ int idxd_wq_disable(struct idxd_wq *wq);
...
index 229386464923..b2e887508078 100644
...
@@ -396,6 +398,50 @@ static int idxd_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
 	return 0;
 }
...
@@ -419,6 +465,8 @@ static void idxd_shutdown(struct pci_dev *pdev)
