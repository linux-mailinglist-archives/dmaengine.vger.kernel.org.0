...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BEA526FB80B
	for <lists+dmaengine@lfdr.de>; Mon,  8 May 2023 22:08:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234274AbjEHUIk (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Mon, 8 May 2023 16:08:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51028 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234067AbjEHUIP (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Mon, 8 May 2023 16:08:15 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 26B7A6EA2;
        Mon,  8 May 2023 13:07:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1683576478; x=1715112478;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=qfiiTbL0IBBRpU0vw3v16yQeSWCDx4nuhaamLWLsflQ=;
  b=G1ycyJ+tjIK0VkiQYWXu0ADEe/T6CGvwaofN3+b1MOmLJC0TgjLQ/oYA
   oFMTnDSwY5JRbMIhuZL0XKGZhHBHqXh3WMB/Mh71kIKnufZmTWD59rCN3
   8zsFn6121wr6w2fp4DkpHUWzmU57ccwR62IbolKBGKCEvg4rLz+xYstgK
   QtT7nfO4xu7uKbn9dLZyCe2swku/LvVtP6KFRAk7kXWQzXJW3tL5BXKsk
   qYH0JbtFcGfjVwGed6zWY8wOO8w4OmWKE0UcaYH84SZdng5WHr6dt2Qg3
   nOq/vEVLLILPcfk9VQ5w8MbrYw9crhrYct8yGXBoP+TtR9O8OWDnGj/W3
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="348573671"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; 
   d="scan'208";a="348573671"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 May 2023 13:07:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10704"; a="788241656"
X-IronPort-AV: E=Sophos;i="5.99,259,1677571200"; 
   d="scan'208";a="788241656"
Received: from sajmal-mobl1.amr.corp.intel.com (HELO tzanussi-mobl1.intel.com) ([10.212.74.4])
  by fmsmga003-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 08 May 2023 13:07:55 -0700
...
Subject: [PATCH v4 08/15] crypto: iaa - Add IAA Compression Accelerator Documentation
Date:   Mon,  8 May 2023 15:07:30 -0500
Message-Id: <5800baedf4b137d603c935a5c0b667a604eaebc3.1683573703.git.zanussi@kernel.org>
...
index 000000000000..a6a716f8b906
--- /dev/null
...
+
+In order to unregister the iaa_crypto algorithm, and register a new
+one using different parameters, any users of the current algorithm
+should be stopped and the IAA workqueues and devices disabled.
+
+In the case of zswap, remove the iaa_crypto algorithm as the
...
+will unregister the current iaa_crypto algorithm::
+
+  rmmod iaa_crypto
+
+
