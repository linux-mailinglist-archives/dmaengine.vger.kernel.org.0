...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A3EAD1330B6
	for <lists+dmaengine@lfdr.de>; Tue,  7 Jan 2020 21:41:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727165AbgAGUlo (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Tue, 7 Jan 2020 15:41:44 -0500
Received: from mga11.intel.com ([192.55.52.93]:33564 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726111AbgAGUln (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Tue, 7 Jan 2020 15:41:43 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga102.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 07 Jan 2020 12:41:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,407,1571727600"; 
   d="scan'208";a="211302464"
Received: from djiang5-desk3.ch.intel.com ([143.182.136.137])
  by orsmga007.jf.intel.com with ESMTP; 07 Jan 2020 12:41:41 -0800
Subject: [PATCH v4 8/9] dmaengine: idxd: connect idxd to dmaengine subsystem
...
Date:   Tue, 07 Jan 2020 13:41:41 -0700
Message-ID: <157842970117.27241.3091654249580952509.stgit@djiang5-desk3.ch.intel.com>
...
index d03cd61c390e..d02cc98bc6db 100644
...
@@ -189,6 +191,9 @@ int idxd_wq_alloc_resources(struct idxd_wq *wq)
...
index 000000000000..2b7c63b1b129
--- /dev/null
...
+}
+
+void idxd_dma_complete_txd(struct idxd_desc *desc, bool force)
+{
...
index d369b75468e3..7e2f1f6f8854 100644
...
@@ -169,6 +171,8 @@ struct idxd_device {
...
+	struct dma_async_tx_descriptor txd;
 	...
 	int id;
@@ -256,4 +261,13 @@ int idxd_submit_desc(struct idxd_wq *wq, struct idxd_desc *desc);
...
index 229386464923..4ac95b011d04 100644
...
index de4b80973c2f..33394dd0af72 100644
...
index 20c683870046..031e4a9e8f10 100644
--- a/drivers/dma/idxd/submit.c
+++ b/drivers/dma/idxd/submit.c
@@ -87,7 +87,9 @@ int idxd_submit_desc(struct idxd_wq *wq, struct idxd_desc *desc)
...
index b6da47b52116..bcbd6020c8ee 100644
