...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A63A377308A
	for <lists+dmaengine@lfdr.de>; Mon,  7 Aug 2023 22:38:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231589AbjHGUif (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Mon, 7 Aug 2023 16:38:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35200 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231487AbjHGUiZ (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Mon, 7 Aug 2023 16:38:25 -0400
Received: from mgamail.intel.com (mgamail.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ABB2B10EC;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=yafoL0d6pcZIlRZ6Y6gbSnzzIFgUreg0zBivmZvO0K4=;
  b=CGzM6Bv2s5nmWceaGXCiuxoeJQLfqCt1s05sfo1jwUaTm6dC96rfBazr
   Qpvs1wqEs1KMPU/q2kjkNi0JgxHAjvW+9TWMP487hQmKM+DaJ4aigGHZa
   Cwa7viWJuRN6rnWw/TNsE/SWM1OM5qYS3A54VwEK7Z24zd7Ec2Sl6A2vf
   c8BkPemZu+EqvFP2AYUQtxA35dvYElabxhnzDf0N5mk9tUYkWgCtABiJb
   3HvFt4WIM/m+RsoQfVQZrj3fQ2HUNfYkkJt5fjQVZvwUMpUhg6N29PScT
   2ZqGWdeXYCgK+phjybv4kTGd7ByWJIX/1tVetMC/m5MdzvMTc19SoKdHQ
   g==;
X-IronPort-AV: E=McAfee;i="6600,9927,10795"; a="374319735"
X-IronPort-AV: E=Sophos;i="6.01,263,1684825200"; 
   d="scan'208";a="374319735"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Aug 2023 13:38:04 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10795"; a="766123380"
X-IronPort-AV: E=Sophos;i="6.01,263,1684825200"; 
   d="scan'208";a="766123380"
Received: from eeroesle-mobl.amr.corp.intel.com (HELO tzanussi-mobl1.intel.com) ([10.212.81.193])
  by orsmga001-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Aug 2023 13:38:02 -0700
...
Subject: [PATCH v9 12/14] crypto: iaa - Add support for deflate-iaa compression algorithm
Date:   Mon,  7 Aug 2023 15:37:24 -0500
Message-Id: <20230807203726.1682123-13-tom.zanussi@linux.intel.com>
...
---
 ...
 drivers/crypto/intel/iaa/iaa_crypto_main.c | 1043 +++++++++++++++++++-
 3 files changed, 1071 insertions(+), 18 deletions(-)
...
index fe60bb71798b..215ac436ff44 100644
...
@@ -724,6 +933,729 @@ static void rebalance_wq_table(void)
 	}
 }
...
@@ -741,6 +1673,11 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
@@ -774,12 +1711,28 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
+	free_iaa_wq(idxd_wq_get_private(wq));
 err_save:
 	if (first_wq)
 		free_wq_table();
@@ -795,6 +1748,9 @@ static int iaa_crypto_probe(struct idxd_dev *idxd_dev)
...
@@ -803,11 +1759,36 @@ static void iaa_crypto_remove(struct idxd_dev *idxd_dev)
...
+	}
 	...
 	mutex_unlock(&iaa_devices_lock);
 	mutex_unlock(&wq->wq_lock);
@@ -833,10 +1814,19 @@ static int __init iaa_crypto_init_module(void)
...
@@ -845,20 +1835,37 @@ static int __init iaa_crypto_init_module(void)
 		goto err_driver_reg;
 	}
