Return-Path: <dmaengine+bounces-2176-lists+dmaengine=lfdr.de@vger.kernel.org>
X-Original-To: lists+dmaengine@lfdr.de
Delivered-To: lists+dmaengine@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A49258CFBA2
	for <lists+dmaengine@lfdr.de>; Mon, 27 May 2024 10:37:49 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id BACAD1C20D54
	for <lists+dmaengine@lfdr.de>; Mon, 27 May 2024 08:37:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F2DAD5577E;
	Mon, 27 May 2024 08:37:44 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b="2qHua/EK"
X-Original-To: dmaengine@vger.kernel.org
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com [185.132.182.106])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A236860263;
	Mon, 27 May 2024 08:37:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.132.182.106
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1716799064; cv=none; b=WaovBMqDmWO29pPNZzoygs5FWGswLX/iJIVDaJkfaZYnYM4RPPNiRsZELbxqLEfiz/ekM4uYMGHeg10iZVSLFjuInaRRW0H+KpXLAMfs7USL1PtRCCrMvlg3s77rCnq+u884tbsQG5UIIJ0BZwLyTD5aNFT8hTo2p8qSmxyehao=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1716799064; c=relaxed/simple;
	bh=hbsXI7Moh2te9N9FRIc7gR9K4yZXV70Txsr8B6wWTDQ=;
	h=Message-ID:Date:MIME-Version:Subject:To:CC:References:From:
	 In-Reply-To:Content-Type; b=oAV7vhvxzYNcJA8Za3DxkkSz2Opstq0xd55+RaeN83nTHyRhGcBz/2IbHzfdNrrYq+y4wSm6IXxbK5OQ8u8aZ+P8xKA70YWmdZFYJGgEbzUa3HYbFimLpL/NSdXKZcUM9nCGcTu/b1gUTKNNZxVJBxFUghwDY6eLLSznJ4L5Oaw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com; spf=pass smtp.mailfrom=foss.st.com; dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b=2qHua/EK; arc=none smtp.client-ip=185.132.182.106
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=foss.st.com
Received: from pps.filterd (m0369458.ppops.net [127.0.0.1])
	by mx07-00178001.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 44R7q0Dt011724;
	Mon, 27 May 2024 10:36:59 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=selector1; bh=
	QOIKkpbQY0EYqPlAJJ49GLq1q2VdZZDe9ueX+9mO8Zs=; b=2qHua/EKq6v5qMio
	
Received: from beta.dmz-ap.st.com (beta.dmz-ap.st.com [138.198.100.35])
	by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3ybsj0c4qh-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 27 May 2024 10:36:58 +0200 (MEST)
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
	by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id 5A6874002D;
	Mon, 27 May 2024 10:36:52 +0200 (CEST)
Received: from Webmail-eu.st.com (shfdag1node3.st.com [10.75.129.71])
	by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 5AF622132C8;
	Mon, 27 May 2024 10:36:02 +0200 (CEST)
Received: from [10.48.86.143] (10.48.86.143) by SHFDAG1NODE3.st.com
 (10.75.129.71) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id 15.1.2507.35; Mon, 27 May
 2024 10:36:01 +0200
Message-ID: <45165956-d47a-46cf-b38e-8ff7a7820f37@foss.st.com>
Date: Mon, 27 May 2024 10:36:01 +0200
Precedence: bulk
...
References: <20240520154948.690697-1-amelie.delaunay@foss.st.com>
 ...
 <ZkuYpxGtayFoQ1W8@lizhi-Precision-Tower-5810>
Content-Language: en-US
From: Amelie Delaunay <amelie.delaunay@foss.st.com>
In-Reply-To: <ZkuYpxGtayFoQ1W8@lizhi-Precision-Tower-5810>
...
Ok, I'll also align comment in the enum below.
...
Ok for adding __packed.

On STM32 SoCs, CPUs and internal peripherals like memories or DMA 
controllers have the same endianess, Liitle Endian. No need to use __le32.
...
You said that one writel() was required to make sure that previous 
writes have actually reached the DDR.

Previous writes that are into DDR are during descriptors initialization, 
which is done in stm32_dma3_chan_prep_hwdesc(), where I added the memory 
barrier.
Descriptors are not modified between stm32_dma3_chan_prep_hwdesc() and 
stm32_dma3_chan_start().
So there is not reason to use writel() here to make sure previous writes 
have reached the DDR. The writes in stm32_dma3_chan_start() are not into 
DDR.
...
Runtime PM will be improved later. Current implementation is not the 
best one, but it ensures not to break PSCI OSI in the meantime.
...
I don't think it ease the review. I prefer to keep dev_addr += chunk in 
each block.
...
On STM32 SoCs, we have never needed to support enqueuing submitted 
transfers.
I take note of your suggestion, in case it becomes necessary.
