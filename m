...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 084AE7230E3
	for <lists+dmaengine@lfdr.de>; Mon,  5 Jun 2023 22:16:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232840AbjFEUQi (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Mon, 5 Jun 2023 16:16:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44288 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232513AbjFEUQR (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Mon, 5 Jun 2023 16:16:17 -0400
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 64C2C114;
        Mon,  5 Jun 2023 13:16:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1685996169; x=1717532169;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=7L1xmOeRxl/SaqBL8yro1Q9GHFKiK254ytIwn3wMFvE=;
  b=FWkEK47kNj1qC6ocD8HL8yBrhrrjtwd8fIe1BJMM6XcLQ0AmfN5nnGKp
   xHprEgM37EcpiPBojBAH7da0uqOIIUPYhdr0Uu6kGFBeIqgFlVRl8MGsp
   6TO3i3SZJ7sqYik+E9iAdLMraaPXgSCpMUkHZqa1R4tBwf+h0tlMAUwi0
   zVLfKb4Y278vyuu2JtQEjY5mlFnyE2GGpbGCXaSD+qOwqUyew8shMjwdF
   zENTU0fYTpjVJjajm10hd6SXY5yeSgNZPhtGIV/Gt+v2mWZfirpFcyFeG
   Utf4wpSahMEGURIJJF1dApZAoIiwAU3J+jp6cHQ7NhYLVGkQNTDjOoRZN
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="356480401"
X-IronPort-AV: E=Sophos;i="6.00,218,1681196400"; 
   d="scan'208";a="356480401"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jun 2023 13:15:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10732"; a="711934456"
X-IronPort-AV: E=Sophos;i="6.00,218,1681196400"; 
   d="scan'208";a="711934456"
Received: from rkbrewer-mobl1.amr.corp.intel.com (HELO tzanussi-mobl1.intel.com) ([10.212.33.16])
  by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Jun 2023 13:15:55 -0700
...
Subject: [PATCH v6 08/15] crypto: iaa - Add IAA Compression Accelerator Documentation
Date:   Mon,  5 Jun 2023 15:15:29 -0500
Message-Id: <20230605201536.738396-9-tom.zanussi@linux.intel.com>
...
index 000000000000..415af34fe572
--- /dev/null
...
+
+Currently, there are only two compression modes available, 'canned'
+and 'fixed' modes.
+
...
+for compression/decompression via the corresponding crypto algorithm
+name::
+
...
+or, for canned::
+
+  # echo deflate-iaa-canned >  /sys/bus/dsa/drivers/crypto/compression_mode
+
+
