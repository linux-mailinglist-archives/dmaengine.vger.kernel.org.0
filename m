Return-Path: <dmaengine+bounces-9616-lists+dmaengine=lfdr.de@vger.kernel.org>
Delivered-To: lists+dmaengine@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id +KG9NGhNwmnvbAQAu9opvQ
	(envelope-from <dmaengine+bounces-9616-lists+dmaengine=lfdr.de@vger.kernel.org>)
	for <lists+dmaengine@lfdr.de>; Tue, 24 Mar 2026 09:38:00 +0100
X-Original-To: lists+dmaengine@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E816304C40
	for <lists+dmaengine@lfdr.de>; Tue, 24 Mar 2026 09:38:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 6E06A30761A6
	for <lists+dmaengine@lfdr.de>; Tue, 24 Mar 2026 08:29:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 20A623D348C;
	Tue, 24 Mar 2026 08:28:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="nvpjcqYM"
X-Original-To: dmaengine@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 306B332B9A8;
	Tue, 24 Mar 2026 08:28:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1774340913; cv=none; b=NcNtwNx+ImldnKRt2+4HMdG+XfUhGEBpt3Wjl4EUHnIGCYrs90HHjWTiF7TU+Tb1vdhB1tUAeQs2TQcgMFe8sLMIJWp5X721fWRwRjNio73qRs7QXKa9km0VAVRTmRpSxUt0fKHXisu0ZcVgkrgTSnxdjh5KDX57ud/bacrgG5M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1774340913; c=relaxed/simple;
	bh=Jl8zSyR0MlZyz/IzaCWe3/m6qDoOJR+HcoWVoG4XyJI=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=J7eSwY+BdRtD4/Qi4aYUsX9fNJ1bGwUPwo1f5APzjn9rduuRChyqG1t2C+EJDqzJWzfV+DMe3OsxUaeNhFfuKv4sBv2Pkz+uvg88IdOTpV6kVcmB7dFTsfjq1cH4xo/nRmLw1vfCmnAdyFuN1Blrt+zCrXqHdtTwxG8P/FJPiIY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=nvpjcqYM; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 90524C2BCB7;
	Tue, 24 Mar 2026 08:28:32 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1774340912;
	bh=Jl8zSyR0MlZyz/IzaCWe3/m6qDoOJR+HcoWVoG4XyJI=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 84BF9F532EF;
	Tue, 24 Mar 2026 08:28:32 +0000 (UTC)
From: Xianwei Zhao via B4 Relay <devnull+xianwei.zhao.amlogic.com@kernel.org>
Date: Tue, 24 Mar 2026 08:28:28 +0000
Subject: [PATCH v7 2/3] dmaengine: amlogic: Add general DMA driver for A9
Precedence: bulk
...
Message-Id: <20260324-amlogic-dma-v7-2-f8b91ee192c1@amlogic.com>
...
X-Mailer: b4 0.14.3
X-Developer-Signature: v=1; a=ed25519-sha256; t=1774340908; l=23124;
 i=xianwei.zhao@amlogic.com; s=20251216; h=from:subject:message-id;
 bh=6gREb9K0VfL1Ez9GKWeaFZ7wACGbiJjqhsrv3Zwaowc=;
 b=WTKo74InvFEh+K1jZKCmOzV/hpE1WXfyAMidsE+94KEoTU2xEh9auxPb3AStE6kSCiuumK8NJ
 jlhukXJOK//A3Cn0IHrggObKSgm2FQ7QidH5Lh8bFN8raa11Guugyaq
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-9616-lists,dmaengine=lfdr.de,xianwei.zhao.amlogic.com];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[amlogic.com:email,amlogic.com:replyto,amlogic.com:mid,sto.lore.kernel.org:helo,sto.lore.kernel.org:rdns,nxp.com:email]
X-Rspamd-Queue-Id: 8E816304C40
...
index 66cda7cc9f7a..7eafd8ab7023 100644
...
index 000000000000..aedb1904cfd1
--- /dev/null
...
+	}
+
+	aml_desc = kmalloc(sizeof(struct aml_dma_desc), GFP_KERNEL);
+	if (!aml_desc)
+		return NULL;
