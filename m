...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2CCC7366F93
	for <lists+dmaengine@lfdr.de>; Wed, 21 Apr 2021 17:58:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235524AbhDUP64 (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Wed, 21 Apr 2021 11:58:56 -0400
Received: from mga18.intel.com ([134.134.136.126]:28536 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S241047AbhDUP6x (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Wed, 21 Apr 2021 11:58:53 -0400
IronPort-SDR: +wmU4RPvT4ji0kmLk7qx8w0JY+iAiMhS929SD9A3yOW9HDmUpOlkBYKpZ4IikyVHwFfWn012vV
 IdgfVoNm863g==
X-IronPort-AV: E=McAfee;i="6200,9189,9961"; a="183210689"
X-IronPort-AV: E=Sophos;i="5.82,240,1613462400"; 
   d="scan'208";a="183210689"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Apr 2021 08:58:19 -0700
IronPort-SDR: lwJMVN8jvG1s6h5iq5AA8hSmtgapB3JVuXr6u662xyJuXApNAnJCRgK917ZyquP7pcQd92fkin
 TRsfUpQxEf0A==
X-IronPort-AV: E=Sophos;i="5.82,240,1613462400"; 
   d="scan'208";a="524337757"
Received: from djiang5-desk3.ch.intel.com ([143.182.136.137])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Apr 2021 08:58:19 -0700
Subject: [PATCH v3] dmaengine: idxd: add interrupt handle request and release
 support
From:   Dave Jiang <dave.jiang@intel.com>
To:     vkoul@kernel.org
Cc:     dmaengine@vger.kernel.org
Date:   Wed, 21 Apr 2021 08:58:18 -0700
Message-ID: <161902056940.4160438.7556759550055377953.stgit@djiang5-desk3.ch.intel.com>
...
v3:
- Replace devm_kcalloc with kcalloc_node, mistake from rebase, caught by
  0-day.
v2:
- Rebased against latest dmaengine/next for 5.13

 drivers/dma/idxd/device.c    |   71 ++++++++++++++++++++++++++++++++++++++++++
 drivers/dma/idxd/idxd.h      |   13 ++++++++
 drivers/dma/idxd/init.c      |   57 +++++++++++++++++++++++++++++++++-
...
index a07e6d8eec00..1d2f8df61a73 100644
...
@@ -288,9 +309,16 @@ static int idxd_setup_internals(struct idxd_device *idxd)
...
+		goto err_wqs;
 	...
 	if (rc < 0)
@@ -317,6 +345,8 @@ static int idxd_setup_internals(struct idxd_device *idxd)
  err_engine:
...
@@ -345,6 +375,12 @@ static void idxd_read_caps(struct idxd_device *idxd)
...
@@ -604,6 +640,24 @@ static void idxd_flush_work_list(struct idxd_irq_entry *ie)
 	}
 }
...
@@ -630,6 +684,7 @@ static void idxd_shutdown(struct pci_dev *pdev)
 	}
