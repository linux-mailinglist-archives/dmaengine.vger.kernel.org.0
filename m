 =?us-ascii?Q?d0mlyLzgS4rSMx9riufbfpKTVl7ibGoVEfNmLvQIOoHiSeGkwGSsktKo3ji0?=
 =?us-ascii?Q?enxbPAxUvr/nFBMJJRIBrx3J3gNIULfuyW+Ow1ACcmmK5IYdzG7rv2+omybP?=
 =?us-ascii?Q?7bNslhn6l68zZQNO1Yg+qQFp6Ltc4XN1NHCA0dq4nHseiWPKzMbW/2N5kUvq?=
 =?us-ascii?Q?iUhhcBIi5WCF4LE3LUs9VnNX0sEU0P40V76XVqNBNg4U0tBIV/rMfszsKTOz?=
 =?us-ascii?Q?EBjbLK3/H6H7tXiJ571k/HZzdtZ24/5vdXDXh5B7mY6kgOuW/yiF+v2xp2Ze?=
 =?us-ascii?Q?cBMhQVPbl9S4Hd6EXjkRKEuU1CfHesWu8ciwG03210f4ajMvJdl1MxVG3uN/?=
 =?us-ascii?Q?glZnbqfIbnANJtS1b+3VYEtYo2g351WNphdJzkBJoh5yNhP8sYHNuAQtyHgM?=
 =?us-ascii?Q?T6P679KR9So96iJPW7ONz5hLklgdKFTDQWFIUsHzWcyUqBwWJwG0Ip2L14EJ?=
 =?us-ascii?Q?NNdaolNgHdKYkCVLANDsZL7OYJ5A05dCNJ15bn8Sy8RwoGksgM6MLNT00JCT?=
 =?us-ascii?Q?/H9GmzXaT6gqlO1I7bJS5BLRsCszNr+eodYWTENHjYr7VRM2iQxqornHdmB6?=
 =?us-ascii?Q?r+6QfUxpYX0KTKyOGHQWF+u42YoVG1Rq+APEvqFR?=
X-OriginatorOrg: nxp.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 5f4fecd2-7c1d-4c28-32fa-08dc78fc11af
X-MS-Exchange-CrossTenant-AuthSource: DB9PR04MB9626.eurprd04.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 20 May 2024 18:38:40.8287
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: Lann7lL+4kRQ7rt7rpithqToFzxp8O7L8PKUFUph5J4xtBLsvEyFD3ogncH4cj8L1JERewSsaSe/YxAEFjc9kw==
...
Can you align comment to tab possiton to easily read code?
...
batter add "pack" also?  Not sure if it needs __le32 here because it is
DMA engine read it, why may difference with CPU's endian.
...
I think you should use general versin dma_wmb() here although it may be
same at most platform. 
...
You need at least ONE writel() here. I already said at v0's patch.
It is very important by using at least ONE writel().
...
Add runtime_pm later. This is not recommended to runtime_pm_resume_get()
at alloc_chan.
...
can you move common part out of if

			src = sg_addr
			...

			if ( (dir == DMA_MEM_TO_DEV) && FIELD_GET(CTR1_DINC, ctr1))
			    || (dir != DMA_MEM_TO_DEV) && FIELD_GET(CTR1_SINC, ctr1))
				dev_addr += chunk;
...
You may improve later. I suggest you linked hardware descripts here before
call stm32_dma3_chan_start(). So hardware can auto run through whole
issue_list without stop.
...
if linked two hw desc, DMA will auto start second sg without wait for
irq handle.
...
You may request_irq when alloc chan. Otherwise there will be long list
cat /proc/interrupts. 

you may improve it later.
