...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C4E872B0193
	for <lists+dmaengine@lfdr.de>; Thu, 12 Nov 2020 10:06:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727753AbgKLJGl (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Thu, 12 Nov 2020 04:06:41 -0500
Received: from mga11.intel.com ([192.55.52.93]:52998 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727709AbgKLJGi (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Thu, 12 Nov 2020 04:06:38 -0500
IronPort-SDR: 8spRWbI38PK1EGAFtUXUWT7D9q9obNyASoQc4m7BSI8z1T7/3Suyg5DWYZpSKRswvsIBiDQy64
 Denm7TbtIqXA==
X-IronPort-AV: E=McAfee;i="6000,8403,9802"; a="166773050"
X-IronPort-AV: E=Sophos;i="5.77,471,1596524400"; 
   d="scan'208";a="166773050"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 12 Nov 2020 01:06:37 -0800
IronPort-SDR: h/0BHNrqe+8JHawtuiIwUSR9C5O3TPF5Je71/pP33DE0ETokJ272cVOqKQA9Li1aH4DWlqU5re
 H/XtxPDvmLEg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,471,1596524400"; 
   d="scan'208";a="360911580"
Received: from jsia-hp-z620-workstation.png.intel.com ([10.221.118.135])
  by fmsmga002.fm.intel.com with ESMTP; 12 Nov 2020 01:06:35 -0800
From:   Sia Jee Heng <jee.heng.sia@intel.com>
To:     vkoul@kernel.org, Eugeniy.Paltsev@synopsys.com, robh+dt@kernel.org
Cc:     andriy.shevchenko@linux.intel.com, dmaengine@vger.kernel.org,
        linux-kernel@vger.kernel.org, devicetree@vger.kernel.org
Subject: [PATCH v3 06/15] dmaengine: dw-axi-dmac: Support device_prep_slave_sg
Date:   Thu, 12 Nov 2020 16:49:44 +0800
Message-Id: <20201112084953.21629-7-jee.heng.sia@intel.com>
...
---
 .../dma/dw-axi-dmac/dw-axi-dmac-platform.c    | 157 ++++++++++++++++++
 drivers/dma/dw-axi-dmac/dw-axi-dmac.h         |   1 +
 2 files changed, 158 insertions(+)

diff --git a/drivers/dma/dw-axi-dmac/dw-axi-dmac-platform.c b/drivers/dma/dw-axi-dmac/dw-axi-dmac-platform.c
index 16e6934ae9a1..b5299d763a43 100644
...
@@ -454,6 +470,144 @@ static void set_desc_dest_master(struct axi_dma_hw_desc *hw_desc,
...
@@ -938,12 +1092,14 @@ static int dw_probe(struct platform_device *pdev)
...
+	dw->dma.directions |= BIT(DMA_MEM_TO_DEV) | BIT(DMA_DEV_TO_MEM);
 	...
 	dw->dma.dev = chip->dev;
@@ -959,6 +1115,7 @@ static int dw_probe(struct platform_device *pdev)
