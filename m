...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5244C5841DB
	for <lists+dmaengine@lfdr.de>; Thu, 28 Jul 2022 16:37:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232210AbiG1Ohg (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Thu, 28 Jul 2022 10:37:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37668 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232692AbiG1OfO (ORCPT
...
Received: from mail.baikalelectronics.com (unknown [87.245.175.230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id C818F43321
        for <dmaengine@vger.kernel.org>; Thu, 28 Jul 2022 07:34:34 -0700 (PDT)
Received: from mail (mail.baikal.int [192.168.51.25])
        by mail.baikalelectronics.com (Postfix) with ESMTP id BB1965F8B;
        Thu, 28 Jul 2022 17:31:34 +0300 (MSK)
DKIM-Filter: OpenDKIM Filter v2.11.0 mail.baikalelectronics.com BB1965F8B
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baikalelectronics.ru; s=mail; t=1659018694;
        bh=N8jtryILAJ8r1VsrC16+OAw6rYXa7/6hFEMbRbgHi5c=;
        h=From:To:CC:Subject:Date:In-Reply-To:References:From;
        b=C3mQRMg4apubwF836/dSxF3a3ZRRwa4M3imksnPr3Vrt7Kc9m7FBeCj/ALkLC4Uhq
         jEq2Q4S9E7d5XID/HW8oIKmsbF0jowV9HBfnPPdp9Xy6oyK14JSz5vwRt9SK0nj85c
         ATDLQFuUv5uwFd7gJTDKl82uwA1hs+O9KrrMDaDI=
Received: from localhost (192.168.53.207) by mail (192.168.51.25) with
 Microsoft SMTP Server (TLS) id 15.0.1395.4; Thu, 28 Jul 2022 17:29:09 +0300
...
Subject: [PATCH v4 24/24] PCI: dwc: Add DW eDMA engine support
Date:   Thu, 28 Jul 2022 17:28:41 +0300
Message-ID: <20220728142841.12305-25-Sergey.Semin@baikalelectronics.ru>
...
index d4db48e4d46a..da3fe7043f7f 100644
...
index 6d201ed1297a..6997c605bf3e 100644
--- a/drivers/pci/controller/dwc/pcie-designware-host.c
+++ b/drivers/pci/controller/dwc/pcie-designware-host.c
@@ -405,14 +405,18 @@ int dw_pcie_host_init(struct dw_pcie_rp *pp)
...
@@ -429,6 +433,9 @@ int dw_pcie_host_init(struct dw_pcie_rp *pp)
 err_stop_link:
...
+
 err_free_msi:
 	if (pp->has_msi_ctrl)
 		dw_pcie_free_msi(pp);
@@ -450,6 +457,8 @@ void dw_pcie_host_deinit(struct dw_pcie_rp *pp)
...
index 4b4dc1136687..6c7a83b75b82 100644
...
index bfe5581edd2e..832a0c43176e 100644
