Return-Path: <dmaengine+bounces-1788-lists+dmaengine=lfdr.de@vger.kernel.org>
X-Original-To: lists+dmaengine@lfdr.de
Delivered-To: lists+dmaengine@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id D852789CB72
	for <lists+dmaengine@lfdr.de>; Mon,  8 Apr 2024 20:06:40 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2ADEE1F21D7E
	for <lists+dmaengine@lfdr.de>; Mon,  8 Apr 2024 18:06:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AD07C1442F7;
	Mon,  8 Apr 2024 18:06:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b="zSuY6qpA"
X-Original-To: dmaengine@vger.kernel.org
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2081.outbound.protection.outlook.com [40.107.93.81])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3AA83433A9;
	Mon,  8 Apr 2024 18:06:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=fail smtp.client-ip=40.107.93.81
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712599595; cv=fail; b=XmS0PfCDJzP7ThUvJNRM5wBCd6VT6ZAu2Ugh7TRLmS4mwUawWVJBfoD2nRDg2twpAG1Qn9+8HIAad1ZbI2aSjmEIJvS2vHMveYI80GE+W81H12RExCa/4gyWXdBhogTDguxwczf4CIqFrjwTo0/lj57B+WwE2HeL0FQdIUku7qs=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712599595; c=relaxed/simple;
	bh=npQCDQxTV1c31wzHhmyKNHxlS3YojfmoFo9dFHclnzk=;
	h=Message-ID:Date:MIME-Version:Subject:To:CC:References:From:
	 In-Reply-To:Content-Type; b=AEq/HPW/0Aj5hQONecu+hxLkppv/kNJ9OLvo/YNanVaETNEATsRyOZL1EWayShFuqciPxzpu9K+tSijLy+AWMDE9Dlif3SMYSH/joVJOk7MSHx1+7ZTTaOJTuG4biIsMhqch5XbPJi8XPTnx97dAaEo9b30XvrM3SskBn6dQjms=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com; spf=fail smtp.mailfrom=amd.com; dkim=pass (1024-bit key) header.d=amd.com header.i=@amd.com header.b=zSuY6qpA; arc=fail smtp.client-ip=40.107.93.81
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=amd.com
Authentication-Results: smtp.subspace.kernel.org; spf=fail smtp.mailfrom=amd.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=DcyZsx6FW3gfWG2BVsR34ap76AcPT9yw7XJ6L68W/m0=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=DcyZsx6FW3gfWG2BVsR34ap76AcPT9yw7XJ6L68W/m0=;
 b=zSuY6qpAiVw4crx18O0//et2jm1s9YKiNFBZ5aDEiRtlhpCsQ3A8aUX/zPnfBw/r9jv9bNcRsfGLX0FbZNt3uH1vCAdmErqJ9N3EWLenxCPpQjBIpcZm1WXaA2WpruFAfhkNj807A54mtMSKtoWvLCIQKRXcSjBZ/2bQWAs3eh0=
...
Received: from BL02EPF0001A102.namprd05.prod.outlook.com
 (2603:10b6:208:160:cafe::e2) by MN2PR13CA0007.outlook.office365.com
 ...
 Transport; Mon, 8 Apr 2024 18:06:27 +0000
...
Received: from SATLEXMB03.amd.com (165.204.84.17) by
 ...
 15.20.7452.22 via Frontend Transport; Mon, 8 Apr 2024 18:06:27 +0000
...
Received: from [172.19.74.144] (10.180.168.240) by SATLEXMB04.amd.com
 ...
 Transport; Mon, 8 Apr 2024 13:06:25 -0500
Message-ID: <aa6a63c0-7cce-1f49-4ae5-3e5d93f98fe5@amd.com>
Date: Mon, 8 Apr 2024 11:06:25 -0700
Precedence: bulk
...
In-Reply-To: <ZhKd7CHXHB7FadY0@matsya>
Content-Type: text/plain; charset="UTF-8"; format=flowed
Content-Transfer-Encoding: 8bit
X-EOPAttributedMessage: 0
X-MS-PublicTrafficType: Email
X-MS-TrafficTypeDiagnostic: BL02EPF0001A102:EE_|SJ0PR12MB6992:EE_
X-MS-Office365-Filtering-Correlation-Id: c3c265be-c08e-47b1-6a60-08dc57f69c56
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Apr 2024 18:06:27.4216
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: c3c265be-c08e-47b1-6a60-08dc57f69c56
...
On 4/7/24 06:21, Vinod Koul wrote:
...
>> --- a/MAINTAINERS
>> +++ b/MAINTAINERS
>> @@ -1063,6 +1063,14 @@ L:	dmaengine@vger.kernel.org
>>   S:	Maintained
>>   F:	drivers/dma/ptdma/
>>   
>> +AMD QDMA DRIVER
...
Ok. I will remove the Copyright
>
>> +#
>> +
...
f->lsb and f->msb is not multiple of 16 or 32.  The code here is to

get the value of data(f->msb : f->lsb).
...
This is used for dma_dev.filter.fn callback. It is an extra check for 
dma_request_chan().

It happens before prep_ calls.
...
The QDMA IP has the same usage cases with Xilinx XDMA IP. 
(platform_data/amd_xdma.h)

The device driver for the product (such as Alveo) which uses XDMA IP 
will instantiate the

platform driver and populate the platdata.
