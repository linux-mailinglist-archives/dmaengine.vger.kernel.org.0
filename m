Return-Path: <dmaengine+bounces-2243-lists+dmaengine=lfdr.de@vger.kernel.org>
X-Original-To: lists+dmaengine@lfdr.de
Delivered-To: lists+dmaengine@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 4118F8D7D0D
	for <lists+dmaengine@lfdr.de>; Mon,  3 Jun 2024 10:11:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2B1E31F215F1
	for <lists+dmaengine@lfdr.de>; Mon,  3 Jun 2024 08:11:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CB14F53E31;
	Mon,  3 Jun 2024 08:11:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b="sWQkoHop"
X-Original-To: dmaengine@vger.kernel.org
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com [185.132.182.106])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 522FF4EB30;
	Mon,  3 Jun 2024 08:11:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.132.182.106
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1717402280; cv=none; b=ZzzB8naXvBA/hTCtluPE/inLtcJBUUA6JjzyC6ktC/Yd79PtQ/fHzLtOVGDKC5UjztBdJWprX4fka9X9mvq9lk3pD4qOEpSbrw3zVKrolSiZKs2YD02/1ezdytdHUpuNr/DB+4DXpE34rHtaVsi6TnroT3EcmAv+FL9dbbyp3iI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1717402280; c=relaxed/simple;
	bh=XgH6RCS24Mx0g5jWYbB8FKXGwwb9Sl1/PAOs9Dg48gI=;
	h=Message-ID:Date:MIME-Version:Subject:To:CC:References:From:
	 In-Reply-To:Content-Type; b=gcm5tuR5pd3dAvK/nsxykZtn9Ry60jf2VnuOqt2+CLpqYDgJrC7+KCca5uik4Ug8MsSYotyFaSXmYLlhnYgfnVO7RUvjmtF1cT1pWnWqKeKUN+8VhkxcwS8wIFOSHOFuGy9o5PPX1TwTQPeUkQc0F1B5S/GeYKC69TG6nD4qNu0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com; spf=pass smtp.mailfrom=foss.st.com; dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b=sWQkoHop; arc=none smtp.client-ip=185.132.182.106
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=foss.st.com
Received: from pps.filterd (m0288072.ppops.net [127.0.0.1])
	by mx07-00178001.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 4537Zaur004031;
	Mon, 3 Jun 2024 10:10:32 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=selector1; bh=
	emAiujT7lvh8Ionv4bqUyC1EIcJrMcWVp7PO0EIma+U=; b=sWQkoHop3TcSHuFw
	
Received: from beta.dmz-ap.st.com (beta.dmz-ap.st.com [138.198.100.35])
	by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3yg7qyv826-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 03 Jun 2024 10:10:32 +0200 (MEST)
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
	by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id 3635440045;
	Mon,  3 Jun 2024 10:10:26 +0200 (CEST)
Received: from Webmail-eu.st.com (shfdag1node3.st.com [10.75.129.71])
	by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id A907A21196D;
	Mon,  3 Jun 2024 10:09:37 +0200 (CEST)
Received: from [10.48.86.143] (10.48.86.143) by SHFDAG1NODE3.st.com
 (10.75.129.71) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id 15.1.2507.35; Mon, 3 Jun
 2024 10:09:36 +0200
Message-ID: <dfc809b3-d53d-4212-81f3-dc3f331d62f7@foss.st.com>
Date: Mon, 3 Jun 2024 10:09:36 +0200
Precedence: bulk
...
In-Reply-To: <ZloxL9qlIKvy/81H@lizhi-Precision-Tower-5810>
...
interrupt (USEF flag set). The function doesn't return a boolean because 
we are already in a case of failure here.

On this error, the hardware automatically disables the channel to 
prevent the execution of the wrongly programmed transfer (it could 
happen when DMA updates its registers from corrupted descriptors).

Channel status is set to DMA_ERROR, reported on dmaengine_tx_status().
A "postmortem" register analysis can be done to find the cause of the 
error, it is what stm32_dma3_check_user_setting() do.
