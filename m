Return-Path: <dmaengine+bounces-10914-lists+dmaengine=lfdr.de@vger.kernel.org>
Delivered-To: lists+dmaengine@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 4CfqMIRgFWoiUwcAu9opvQ
	(envelope-from <dmaengine+bounces-10914-lists+dmaengine=lfdr.de@vger.kernel.org>)
	for <lists+dmaengine@lfdr.de>; Tue, 26 May 2026 10:57:40 +0200
X-Original-To: lists+dmaengine@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id B18905D2D14
	for <lists+dmaengine@lfdr.de>; Tue, 26 May 2026 10:57:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 8AA5334752D9
	for <lists+dmaengine@lfdr.de>; Tue, 26 May 2026 08:49:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 989113CFF55;
	Tue, 26 May 2026 08:48:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="PBEpyu0S"
X-Original-To: dmaengine@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7D8543CFF4D;
	Tue, 26 May 2026 08:48:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=100.103.45.18
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779785328; cv=none; b=G93vDrmVs+ZXX5hyawHJyiEjCyt+AFWXCEHpRklEW8hesNmtVO+2oPSwip4CaPXFzckJSY8uXiyeDoWGjcAGdtJ+XEhQ3VqC7hZwad9se4J4iMYHnDJQ49qaR7nUAsMDd4E2TaEQtZdBYQ0iaW0jynNwpDjW0y1HdPPUenLLWrE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779785328; c=relaxed/simple;
	bh=BZ8T8t6Z/GwXbDAsAYVZ1FdnKvmmtyXc0VCxnm7ipho=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=JUQLI1tkqit30+pj6S5WP1dpmmcnZKoV+nf/8Xg6tzG0zOx2KU2ii0OddU8NM/bp7HSMrehYlRyTLGL1E9pTLlJmeigLen2wN49+bzQHx0LIc2r6eiEB7+mnY5zcopXDpcanl8UCJNswGw4YuN3wSmdKmxAcltQ4Fy6grGgZ4Og=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=PBEpyu0S; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 0BE061F000E9;
	Tue, 26 May 2026 08:48:41 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel.org;
	s=k20260515; t=1779785326;
	bh=0ukiRAjs+pKhEN0LMMkNyZXCYn+c2SLSyeX32mRunwM=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References;
	b=
...
Subject: [PATCH v6 17/18] ASoC: renesas: rz-ssi: Use generic PCM dmaengine APIs
Date: Tue, 26 May 2026 11:47:09 +0300
Message-ID: <20260526084710.3491480-18-claudiu.beznea@kernel.org>
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-10914-lists,dmaengine=lfdr.de];
...
Changes in v6:
- collected tags
- in rz_ssi_interrupt() added extra validity checkes for playback/capture
  substream and the ssi->dmas[] as suggested by sashiko
...
- added 2 struct snd_soc_component_driver, one for PIO mode, one for
 ...
 sound/soc/renesas/rz-ssi.c | 394 +++++++++++++------------------------
...
index d4e1dded3a9c..9fe8a639c47c 100644
...
@@ -843,7 +702,7 @@ static int rz_ssi_dai_trigger(struct snd_pcm_substream *substream, int cmd,
 {
...
@@ -858,28 +717,7 @@ static int rz_ssi_dai_trigger(struct snd_pcm_substream *substream, int cmd,
...
+		if (!rz_ssi_is_dma_enabled(ssi)) {
 			...
 			if (ret)
 				return ret;
@@ -975,6 +813,8 @@ static void rz_ssi_shutdown(struct snd_pcm_substream *substream,
...
@@ -1026,6 +866,12 @@ static int rz_ssi_dai_hw_params(struct snd_pcm_substream *substream,
 		return -EINVAL;
 	}
...
@@ -1041,10 +887,21 @@ static int rz_ssi_dai_hw_params(struct snd_pcm_substream *substream,
 	if (ret)
 		return ret;
...
@@ -1058,9 +915,9 @@ static const struct snd_pcm_hardware rz_ssi_pcm_hardware = {
...
+	.period_bytes_max	= 48 * 1024,
 	...
 	.periods_min		= 1,
@@ -1068,8 +925,8 @@ static const struct snd_pcm_hardware rz_ssi_pcm_hardware = {
 	.fifo_size		= 32 * 2,
 };
...
@@ -1077,6 +934,13 @@ static int rz_ssi_pcm_open(struct snd_soc_component *component,
...
+
 static snd_pcm_uframes_t rz_ssi_pcm_pointer(struct snd_soc_component *component,
 					    struct snd_pcm_substream *substream)
 {
@@ -1093,7 +957,8 @@ static int rz_ssi_pcm_new(struct snd_soc_component *component,
 {
...
@@ -1116,16 +981,30 @@ static struct snd_soc_dai_driver rz_ssi_soc_dai[] = {
 	},
 };
...
@@ -1141,7 +1020,6 @@ static int rz_ssi_probe(struct platform_device *pdev)
 	if (IS_ERR(ssi->base))
...
@@ -1165,16 +1043,43 @@ static int rz_ssi_probe(struct platform_device *pdev)
...
@@ -1185,17 +1090,13 @@ static int rz_ssi_probe(struct platform_device *pdev)
...
@@ -1307,7 +1184,6 @@ static struct platform_driver rz_ssi_driver = {
