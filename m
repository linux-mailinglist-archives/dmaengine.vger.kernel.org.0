...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 49AFF12B185
	for <lists+dmaengine@lfdr.de>; Fri, 27 Dec 2019 06:50:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725904AbfL0Fuy (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Fri, 27 Dec 2019 00:50:54 -0500
Received: from mail.kernel.org ([198.145.29.99]:60092 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725854AbfL0Fuy (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Fri, 27 Dec 2019 00:50:54 -0500
Received: from localhost (unknown [106.201.34.211])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id DDF6E20882;
        Fri, 27 Dec 2019 05:50:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1577425851;
        bh=F3aeI293ic7IeRbeoAsD4FX6Mtmhbm9Pl0fioeR4oLw=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=CsI7/9zQyJ+quZzq497i4CcnSQ0C60K4axotrmn2aetfdEf4LwyqDfOnWXeAc+enO
         s4nT64nhHLvLqiv+kH8E4sDps6SIH+PWA30/vrSP01JY6+gAgD9cV1UMOZZGNBEHDt
         L68h2RPKlyhIylPW2nUJEY1usSaMN55GvQFakUZY=
Date:   Fri, 27 Dec 2019 11:20:44 +0530
...
Subject: Re: [PATCH RFC v3 09/14] dmaengine: idxd: add configuration
 component of driver
Message-ID: <20191227055044.GD3006@vkoul-mobl>
...
In-Reply-To: <157662563384.51652.3992335266597447951.stgit@djiang5-desk3.ch.intel.com>
...
>  6 files changed, 1530 insertions(+), 2 deletions(-)
...
> index 039a3cb84214..076456357962 100644
...
>  
> @@ -201,7 +202,28 @@ static inline void idxd_set_type(struct idxd_device *idxd)
...
> @@ -223,9 +245,12 @@ int idxd_device_config(struct idxd_device *idxd);
...
> index 000000000000..b6da47b52116
> --- /dev/null
