...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1F13D665C0F
	for <lists+dmaengine@lfdr.de>; Wed, 11 Jan 2023 14:03:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232762AbjAKNDg (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Wed, 11 Jan 2023 08:03:36 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35494 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229725AbjAKNDM (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Wed, 11 Jan 2023 08:03:12 -0500
Received: from mail-lf1-x131.google.com (mail-lf1-x131.google.com [IPv6:2a00:1450:4864:20::131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0E84A3B5;
        Wed, 11 Jan 2023 05:03:08 -0800 (PST)
Received: by mail-lf1-x131.google.com with SMTP id bq39so23443316lfb.0;
        Wed, 11 Jan 2023 05:03:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=z0HvScm5aOO3U6wi7zk5sW8RKHC+ikPDuzhYo0xJza8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=z0HvScm5aOO3U6wi7zk5sW8RKHC+ikPDuzhYo0xJza8=;
        b=
X-Gm-Message-State: AFqh2krVdEle8Vg5oUy69RWg6lEMrLoXryzuICvq91CXddjFh3/BvPIC
        EI7zK+gi/zR3kCHn1p7UA6u/PnJENFE9zA==
X-Google-Smtp-Source: AMrXdXt91Q2WdQ1P4+sUd3xD+uOl5c0VNs6O+mOS2IFxz9byEfZpo/fXwsIAxm9OL3g5KgMsMDUdYA==
X-Received: by 2002:a05:6512:3f1e:b0:4c0:91d0:e7ab with SMTP id y30-20020a0565123f1e00b004c091d0e7abmr23087532lfa.28.1673442185043;
        Wed, 11 Jan 2023 05:03:05 -0800 (PST)
Received: from mobilestation ([95.79.133.202])
        by smtp.gmail.com with ESMTPSA id bi41-20020a0565120ea900b004cc7026d95asm2654319lfb.259.2023.01.11.05.03.03
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 11 Jan 2023 05:03:04 -0800 (PST)
Date:   Wed, 11 Jan 2023 16:03:01 +0300
...
Message-ID: <20230111130301.xm6ci3v5nr7pempk@mobilestation>
References: <20221219144658.26620-27-Sergey.Semin@baikalelectronics.ru>
 <202212201019.zbdcz1of-lkp@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <202212201019.zbdcz1of-lkp@intel.com>
...
On Tue, Dec 20, 2022 at 11:01:08AM +0800, kernel test robot wrote:
> Hi Serge,
> 
...
Right. By the original design the driver expects these addresses being
backed by MMIO (see drivers/dma/dw-edma/dw-edma-pcie.c). This
patchset introduces a hardware support in which the linked-lists are
supposed to be allocated in the system memory. So in order to fix the
denoted sparse warning I have to fix the SET_LL_32() and SET_LL_64()
macros usage. It's not that easy because currently the driver casts
the __iomem void-pointers to the __iomem struct-pointers and then
passes fields for the structure to the denoted macros. Luckily the
macros are used in the dw_edma_v0_core_write_chunk() function only.
I'll think of the best solution for that.
