...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C00033E27DB
	for <lists+dmaengine@lfdr.de>; Fri,  6 Aug 2021 11:53:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244763AbhHFJxv (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Fri, 6 Aug 2021 05:53:51 -0400
Received: from relmlor2.renesas.com ([210.160.252.172]:23306 "EHLO
        relmlie6.idc.renesas.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S231672AbhHFJxu (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Fri, 6 Aug 2021 05:53:50 -0400
X-IronPort-AV: E=Sophos;i="5.84,300,1620658800"; 
   d="scan'208";a="90014103"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 06 Aug 2021 18:53:34 +0900
Received: from localhost.localdomain (unknown [10.226.92.62])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id A852542127CA;
        Fri,  6 Aug 2021 18:53:32 +0900 (JST)
...
Subject: [PATCH v7 3/3] drivers: dma: sh: Add DMAC driver for RZ/G2L SoC
Date:   Fri,  6 Aug 2021 10:53:22 +0100
Message-Id: <20210806095322.2326-4-biju.das.jz@bp.renesas.com>
...
---
v6->v7:
 * As per the DMA documention vc.lock must be held by caller vchan_cookie_complete.
   So fixed that issue.
 * Added spin_lock protection for the lists used in rz_dmac_terminate_all.
v5->v6:
 * Fixed dma_addr_t and size_t format specifier issue reported by kernel
   test robot
...
index 000000000000..11986a8d22fc
--- /dev/null
