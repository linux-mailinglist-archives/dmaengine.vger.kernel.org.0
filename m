...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9B3D47D1C24
	for <lists+dmaengine@lfdr.de>; Sat, 21 Oct 2023 11:38:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229583AbjJUJiD (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Sat, 21 Oct 2023 05:38:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58278 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229472AbjJUJiC (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Sat, 21 Oct 2023 05:38:02 -0400
Received: from szxga02-in.huawei.com (szxga02-in.huawei.com [45.249.212.188])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 827F61A3;
        Sat, 21 Oct 2023 02:37:58 -0700 (PDT)
Received: from kwepemm000013.china.huawei.com (unknown [172.30.72.57])
        by szxga02-in.huawei.com (SkyGuard) with ESMTP id 4SCGVR49b0zNmML;
        Sat, 21 Oct 2023 17:33:51 +0800 (CST)
...
Subject: [PATCH v5 1/2] dmaengine: Add HiSilicon Ascend SDMA engine support
Date:   Sat, 21 Oct 2023 17:34:52 +0800
Message-ID: <20231021093454.39822-2-guomengqi3@huawei.com>
...
index 70ba506dabab..afbf761f25aa 100644
--- a/drivers/dma/Kconfig
+++ b/drivers/dma/Kconfig
@@ -244,6 +244,16 @@ config FSL_RAID
...
+	struct device *dev = sc->sdev->dev;
+
+	if (!dst || !src || !len || (len >= SDMA_MAX_COPY_SIZE) || (dst == src) ||
...
+		entry->sssv            = 1;
+		entry->dssv            = 1;
+		entry->src_substreamid = current->mm->pasid;
+		entry->dst_substreamid = current->mm->pasid;
+	} else {
+		entry->sssv = 0;
+		entry->dssv = 0;
+	}
