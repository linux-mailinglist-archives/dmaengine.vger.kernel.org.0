In-Reply-To: <CAAhV-H4TH+DbC2XsvysS7yH+M99qhHdpADACGdM0Q83FztSvFg@mail.gmail.com>
From: Keguang Zhang <keguang.zhang@gmail.com>
Date: Tue, 2 Apr 2024 09:55:42 +0800
Message-ID: <CAJhJPsU6agzBR1jOw73SpMoogUMYu0qQT2VaBa+z1DXw2ZPNvw@mail.gmail.com>
...
wrote:
>
> On Mon, Apr 1, 2024 at 7:10=E2=80=AFPM Keguang Zhang <keguang.zhang@gmail=
.com> wrote:
> >
> > On Mon, Apr 1, 2024 at 5:06=E2=80=AFPM Huacai Chen <chenhuacai@kernel.o=
rg> wrote:
> > >
> > > On Mon, Apr 1, 2024 at 10:45=E2=80=AFAM Keguang Zhang <keguang.zhang@=
gmail.com> wrote:
> > > >
> > > > Hi Huacai,
> > > >
> > > > On Sat, Mar 30, 2024 at 9:59=E2=80=AFPM Huacai Chen <chenhuacai@ker=
nel.org> wrote:
> > > > >
> > > > > Hi, Keguang,
> > > > >
> > > > > On Fri, Mar 29, 2024 at 7:28=E2=80=AFPM Keguang Zhang via B4 Rela=
y
...
> > > > > > - Rename the file to loongson1-apb-dma.c to keep the consistenc=
y
> > > > > >
> > > > > > Changes in v6:
...
> > > > > > - and rearrange it in alphabetical order in Kconfig and Makefil=
e.
> > > > > > - Fix comment style.
> > > > > > ---
...
> > > > > > +       help
> > > > > > +         This selects support for the APB DMA controller in Lo=
ongson1 SoCs,
> > > > > > +         which is required by Loongson1 NAND and audio support=
.
> > > > > Why not rename to LS1X_APB_DMA and put it just before LS2X_APB_DM=
A
...
> > >
> > Indeed, that's an exception, which was submitted by Jiaxun several year=
s ago.
...
> > > > > > diff --git a/drivers/dma/loongson1-apb-dma.c b/drivers/dma/loon=
gson1-apb-dma.c
...
> > > > > > + *
> > > > > > + * Copyright (C) 2015-2024 Keguang Zhang <keguang.zhang@gmail.=
com>
> > > > > > + */
> > > > > > +
...
> > > > > > +       ret =3D readl_poll_timeout_atomic(chan->reg_base + DMA_=
CTRL, val,
> > > > > > +                                       !(val & DMA_ASK_VALID),=
 0, 3000);
> > > > > > +       if (ret)
...
> > > > > > +       int val, ret;
> > > > > > +
> > > > > > +       dev_dbg(chan2dev(dchan), "cookie=3D%d, starting hwdesc=
=3D%x\n",
...
> > > > > > +       val |=3D dchan->chan_id;
> > > > > > +       chan_writel(chan, DMA_CTRL, val);
> > > > > > +       ret =3D readl_poll_timeout(chan->reg_base + DMA_CTRL, v=
al,
...
> > > > > > +}
> > > > > > +
> > > > > > +static void ls1x_dma_free_chan_resources(struct dma_chan *dcha=
n)
> > > > > > +{
> > > > > > +       struct ls1x_dma_chan *chan =3D to_ls1x_dma_chan(dchan);
> > > > > > +
> > > > > > +       dma_free_coherent(chan2dev(dchan), sizeof(struct ls1x_d=
ma_hwdesc),
> > > > > > +                         chan->curr_hwdesc, chan->curr_hwdesc_=
phys);
...
> > > > > > +}
> > > > > > +
> > > > > > +static int ls1x_dma_alloc_chan_resources(struct dma_chan *dcha=
n)
> > > > > > +{
> > > > > > +       struct ls1x_dma_chan *chan =3D to_ls1x_dma_chan(dchan);
> > > > > > +
...
> > > > > > +                                         chan2dev(dchan),
> > > > > > +                                         sizeof(struct ls1x_dm=
a_hwdesc),
> > > > > > +                                         __alignof__(struct ls=
1x_dma_hwdesc),
> > > > > > +                                         0);
> > > > > > +       if (!chan->desc_pool)
> > > > > > +               return -ENOMEM;
...
tx.chan);
> > > > > > +
> > > > > > +       dma_pool_free(chan->desc_pool, desc->hwdesc, desc->hwde=
sc_phys);
> > > > > > +       chan->desc =3D NULL;
> > > > > > +       kfree(desc);
> > > > > > +}
...
> > > > > > +               dev_err(chan2dev(dchan), "sg_len %u exceeds lim=
it %lu",
...
> > > > > > +       desc->hwdesc =3D dma_pool_zalloc(chan->desc_pool, GFP_N=
OWAIT,
> > > > > > +                                      &desc->hwdesc_phys);
> > > > > > +       if (!desc->hwdesc) {
> > > > > > +               dev_err(chan2dev(dchan), "failed to alloc HW de=
scriptors\n");
...
> > > > > > +               break;
> > > > > > +       default:
> > > > > > +               dev_err(chan2dev(dchan), "unsupported DMA direc=
tion: %s\n",
...
> > > > > > +               struct ls1x_dma_hwdesc *hwdesc =3D &desc->hwdes=
c[i];
> > > > > > +
> > > > > > +               if (!is_dma_copy_aligned(dchan->device, buf_add=
r, 0, buf_len)) {
> > > > > > +                       dev_err(chan2dev(dchan), "buffer is not=
 aligned!\n");
> > > > > > +                       return -EINVAL;
> > > > > > +               }
> > > > > > +
...
> > > > > > +                       desc->hwdesc[i - 1].next =3D next_hwdes=
c_phys
> > > > > > +                           | DMA_NEXT_VALID;
> > > > > > +               }
> > > > > > +       }
...
c[i];
> > > > > > +
> > > > > > +               print_hex_dump_debug("HW DESC: ", DUMP_PREFIX_O=
FFSET, 16, 4,
> > > > > > +                                    hwdesc, sizeof(*hwdesc), f=
alse);
> > > > > > +       }
> > > > > > +
> > > > > > +       return 0;
...
> > > > > > +                      struct scatterlist *sgl, unsigned int sg=
_len,
> > > > > > +                      enum dma_transfer_direction direction,
...
> > > > > > +                        dma_addr_t buf_addr, size_t buf_len, s=
ize_t period_len,
> > > > > > +                        enum dma_transfer_direction direction,
> > > > > > +                        unsigned long flags)
> > > > > > +{
...
> > > > > > +               "buf_len=3D%d period_len=3D%zu flags=3D0x%lx di=
r=3D%s\n", buf_len,
> > > > > > +               period_len, flags, dmaengine_get_direction_text=
(direction));
> > > > > > +
...
> > > > > > +               sg_set_page(&sgl[i], pfn_to_page(PFN_DOWN(buf_a=
ddr)),
...
> > > > > > +}
> > > > > > +
> > > > > > +static enum dma_status ls1x_dma_tx_status(struct dma_chan *dch=
an,
> > > > > > +                                         dma_cookie_t cookie,
> > > > > > +                                         struct dma_tx_state *=
state)
...
> > > > > > +       if (chan->desc && cookie =3D=3D chan->desc->vdesc.tx.co=
okie) {
> > > > > > +               struct ls1x_dma_desc *desc =3D chan->desc;
> > > > > > +               int i;
> > > > > > +
> > > > > > +               if (ls1x_dma_query(chan, &chan->curr_hwdesc_phy=
s))
> > > > > > +                       return status;
> > > > > > +
> > > > > > +               /* locate the current HW descriptor */
> > > > > > +               for (i =3D 0; i < desc->nr_descs; i++)
> > > > > > +                       if (desc->hwdesc[i].next =3D=3D chan->c=
urr_hwdesc->next)
> > > > > > +                               break;
> > > > > > +
> > > > > > +               /* count the residues */
> > > > > > +               for (; i < desc->nr_descs; i++)
> > > > > > +                       bytes +=3D desc->hwdesc[i].length * des=
c->bus_width;
> > > > > > +
...
> > > > > > +                        "IRQ %d with no active descriptor on c=
hannel %d\n",
> > > > > > +                        irq, dchan->chan_id);
> > > > > > +               return IRQ_NONE;
> > > > > > +       }
...
> > > > > > +                              struct ls1x_dma *dma, int chan_i=
d)
> > > > > > +{
...
> > > > > > +       chan->irq =3D platform_get_irq_byname(pdev, pdev_irqnam=
e);
> > > > > > +       if (chan->irq < 0)
> > > > > > +               return -ENODEV;
> > > > > > +
...
> > > > > > +               return -ENOMEM;
> > > > > > +
> > > > > > +       ret =3D devm_request_irq(dev, chan->irq, ls1x_dma_irq_h=
andler,
...
> > > > > > +}
> > > > > > +
> > > > > > +static void ls1x_dma_chan_remove(struct ls1x_dma *dma, int cha=
n_id)
> > > > > > +{
...
> > > > > > +                                    "nr_chans=3D%d exceeds the=
 maximum\n",
> > > > > > +                                    nr_chans);
> > > > > > +
> > > > > > +       dma =3D devm_kzalloc(dev, struct_size(dma, chan, nr_cha=
ns), GFP_KERNEL);
> > > > > > +       if (!dma)
> > > > > > +               return -ENOMEM;
> > > > > > +
...
> > > > > > +           BIT(DMA_SLAVE_BUSWIDTH_2_BYTES) | BIT(DMA_SLAVE_BUS=
WIDTH_4_BYTES);
> > > > > > +       ddev->dst_addr_widths =3D BIT(DMA_SLAVE_BUSWIDTH_1_BYTE=
) |
> > > > > > +           BIT(DMA_SLAVE_BUSWIDTH_2_BYTES) | BIT(DMA_SLAVE_BUS=
WIDTH_4_BYTES);
> > > > > > +       ddev->directions =3D BIT(DMA_DEV_TO_MEM) | BIT(DMA_MEM_=
TO_DEV);
> > > > > > +       ddev->max_sg_burst =3D LS1X_DMA_MAX_DESC;
> > > > > > +       ddev->residue_granularity =3D DMA_RESIDUE_GRANULARITY_S=
EGMENT;
> > > > > > +       ddev->device_alloc_chan_resources =3D ls1x_dma_alloc_ch=
an_resources;
> > > > > > +       ddev->device_free_chan_resources =3D ls1x_dma_free_chan=
_resources;
> > > > > > +       ddev->device_prep_slave_sg =3D ls1x_dma_prep_slave_sg;
> > > > > > +       ddev->device_prep_dma_cyclic =3D ls1x_dma_prep_dma_cycl=
ic;
...
> > > > > > +
> > > > > > +       ret =3D
> > > > > > +           of_dma_controller_register(dev->of_node, of_dma_xla=
te_by_chan_id,
> > > > > > +                                      ddev);
> > > > > > +       if (ret) {
