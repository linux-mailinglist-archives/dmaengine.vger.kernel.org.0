Return-Path: <dmaengine+bounces-2251-lists+dmaengine=lfdr.de@vger.kernel.org>
X-Original-To: lists+dmaengine@lfdr.de
Delivered-To: lists+dmaengine@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 201998FAD3C
	for <lists+dmaengine@lfdr.de>; Tue,  4 Jun 2024 10:14:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 5E60FB21A0B
	for <lists+dmaengine@lfdr.de>; Tue,  4 Jun 2024 08:14:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 10B5E1420C6;
	Tue,  4 Jun 2024 08:14:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b="4v8Zl0KO"
X-Original-To: dmaengine@vger.kernel.org
Received: from mx08-00178001.pphosted.com (mx08-00178001.pphosted.com [91.207.212.93])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D5561446CF;
	Tue,  4 Jun 2024 08:14:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.207.212.93
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1717488866; cv=none; b=uWhjw7CdslmETGJe0m4+KB5AJJrk8NS4EjSgA40ogtpBH+BVE8OiHh4xuwadozvUc194WNS0w3KgdPEfFe33fqV7YOE52Vs1/Jv+RMkc3P2mv3CgyoNBT8TVQ91LyVct4ux2XJwa92KZKFzOM8FYnbrwAcfSEjgdKjSxqkJAuf4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1717488866; c=relaxed/simple;
	bh=5LnbqMZi4X7zOqh8TglpEM+/2K35GPdZsNvmCf8Ozgc=;
	h=Message-ID:Date:MIME-Version:Subject:To:CC:References:From:
	 In-Reply-To:Content-Type; b=T679GagLPTbp6waDVH3CkyOpAJ+ifrWwJ3SvuVkz8zwW/cljkgMGFSwUxA3l6Q4kVYh+B5AvdDsTtIQmGWaCaZssw1s8cFFRRSwuZO4IcLnRoR2IG7x4qyuhTRM1/57Pq+9sjwqnvWx20TBYEhJa7Plzs33/vn1wAp1Blto05Ms=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com; spf=pass smtp.mailfrom=foss.st.com; dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b=4v8Zl0KO; arc=none smtp.client-ip=91.207.212.93
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=foss.st.com
Received: from pps.filterd (m0369457.ppops.net [127.0.0.1])
	by mx07-00178001.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 4543kGU6018398;
	Tue, 4 Jun 2024 10:13:50 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=
	cc:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=selector1; bh=
	0qDHQfEXJlaBzOjvovUQMwBb6vXG7aIe4yFJR1UJgUo=; b=4v8Zl0KOEAIG7TK5
	
Received: from beta.dmz-ap.st.com (beta.dmz-ap.st.com [138.198.100.35])
	by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3ygekhrra4-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 04 Jun 2024 10:13:49 +0200 (MEST)
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
	by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id E35C94002D;
	Tue,  4 Jun 2024 10:13:44 +0200 (CEST)
Received: from Webmail-eu.st.com (shfdag1node3.st.com [10.75.129.71])
	by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 2545C212FD9;
	Tue,  4 Jun 2024 10:12:54 +0200 (CEST)
Received: from [10.48.86.143] (10.48.86.143) by SHFDAG1NODE3.st.com
 (10.75.129.71) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id 15.1.2507.35; Tue, 4 Jun
 2024 10:12:53 +0200
Message-ID: <3062b972-dedf-4f34-917b-654ef7de6d51@foss.st.com>
Date: Tue, 4 Jun 2024 10:12:52 +0200
Precedence: bulk
...
References: <20240531150712.2503554-1-amelie.delaunay@foss.st.com>
 ...
 <Zl3ZoTDS4ZoP6ZPw@lizhi-Precision-Tower-5810>
Content-Language: en-US
From: Amelie Delaunay <amelie.delaunay@foss.st.com>
In-Reply-To: <Zl3ZoTDS4ZoP6ZPw@lizhi-Precision-Tower-5810>
...
Unless there are any further comments justifying a new patchset version, 
I won't send a new version just to change this internal function name.

I'm not convinced by "dump_err_message" either, because the function 
does not extract an error message from somewhere, it analyzes (checks) 
user parameters (user setting as in Reference Manual) from configuration 
registers, and logs an error in case of any invalid configuration.
