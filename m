Return-Path: <dmaengine+bounces-11125-lists+dmaengine=lfdr.de@vger.kernel.org>
Delivered-To: lists+dmaengine@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id VhBkFxb6HmqVbQAAu9opvQ
	(envelope-from <dmaengine+bounces-11125-lists+dmaengine=lfdr.de@vger.kernel.org>)
	for <lists+dmaengine@lfdr.de>; Tue, 02 Jun 2026 17:43:18 +0200
X-Original-To: lists+dmaengine@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id B7E8062FE85
	for <lists+dmaengine@lfdr.de>; Tue, 02 Jun 2026 17:43:17 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=sntech.de header.s=gloria202408 header.b="RF/AKV5N";
	spf=pass (mail.lfdr.de: domain of "dmaengine+bounces-11125-lists+dmaengine=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="dmaengine+bounces-11125-lists+dmaengine=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=quarantine) header.from=sntech.de;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 70E243082E4F
	for <lists+dmaengine@lfdr.de>; Tue,  2 Jun 2026 15:06:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C3EED3E63A6;
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-11125-lists,dmaengine=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
 ...
 x-spi@vger.kernel.org,m:linux-mediatek@lists.infradead.org,m:krzk@kernel.org,m:conor@kernel.org,s:lists@lfdr.de];
	...
	FORGED_SENDER(0.00)[heiko@sntech.de,dmaengine@vger.kernel.org];
	...
	FROM_NEQ_ENVFROM(0.00)[heiko@sntech.de,dmaengine@vger.kernel.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[vger.kernel.org:from_smtp,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,phil:mid,sntech.de:dkim,sntech.de:from_mime,sntech.de:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: B7E8062FE85
