...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EC99CF75A1
	for <lists+dmaengine@lfdr.de>; Mon, 11 Nov 2019 14:54:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726994AbfKKNx3 (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Mon, 11 Nov 2019 08:53:29 -0500
Received: from lelv0142.ext.ti.com ([198.47.23.249]:52158 "EHLO
        lelv0142.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727365AbfKKNx2 (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Mon, 11 Nov 2019 08:53:28 -0500
Received: from fllv0035.itg.ti.com ([10.64.41.0])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id xABDrEFw010756;
        Mon, 11 Nov 2019 07:53:14 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1573480394;
        bh=IQ8jDPspTEtLn8oaIl/j/SudZ+atoLpLf8UFFMYti1A=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=tV37PIKywlIQ0/qLmh027AXVjYDG7uoGIGEESkFQoUiM7RS/kMcjmZnNULCirs13t
         lHi7W7r+Z1xpN45zeFEoXMxoZGwcWr272cyE2hG5aYJbnHRqfTSZD889dcKkWoGqic
         MpCVU8bi3ZdqX4hRuL83+lj/diNK1/96Yqvxw6lo=
Received: from DFLE105.ent.ti.com (dfle105.ent.ti.com [10.64.6.26])
        by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTP id xABDrDh0046815;
        Mon, 11 Nov 2019 07:53:14 -0600
Received: from DFLE100.ent.ti.com (10.64.6.21) by DFLE105.ent.ti.com
 (10.64.6.26) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3; Mon, 11
 Nov 2019 07:52:56 -0600
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE100.ent.ti.com
 (10.64.6.21) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3 via
 Frontend Transport; Mon, 11 Nov 2019 07:52:56 -0600
Received: from feketebors.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id xABDqE92097668;
...
Subject: [PATCH v5 15/15] dmaengine: ti: k3-udma: Add glue layer for non DMAengine users
Date:   Mon, 11 Nov 2019 15:53:30 +0200
Message-ID: <20191111135330.8235-16-peter.ujfalusi@ti.com>
...
index 8cffc41b9d38..054d6d5f3a20 100644
--- a/drivers/dma/ti/k3-udma.c
+++ b/drivers/dma/ti/k3-udma.c
@@ -1046,6 +1046,64 @@ static irqreturn_t udma_udma_irq_handler(int irq, void *data)
 	return IRQ_HANDLED;
 }
...
@@ -3334,6 +3392,9 @@ static struct platform_driver udma_driver = {
