...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A7C094C3741
	for <lists+dmaengine@lfdr.de>; Thu, 24 Feb 2022 21:56:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232653AbiBXU4B (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Thu, 24 Feb 2022 15:56:01 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38780 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231428AbiBXU4A (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Thu, 24 Feb 2022 15:56:00 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AFA871C6EDD;
        Thu, 24 Feb 2022 12:55:27 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 2DCB2618EB;
        Thu, 24 Feb 2022 20:55:27 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A5A42C340E9;
        Thu, 24 Feb 2022 20:55:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1645736126;
        bh=j6VkHxVCiNp7MpibjDCX8XJDKSYjWSHAhDpiQDukaiw=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Thu, 24 Feb 2022 13:55:20 -0700
...
Message-ID: <YhfwuCA71h8vMYUQ@dev-arch.archlinux-ax161>
...
Adding a CONFIG_ARM64 depends here does not do anything for avoiding the
warning reported at [1], as CONFIG_COMPILE_TEST allows this driver to be
compiled on architectures that have a 32-bit dma_addr_t (such as
ARCH=arm).
...
so that dma_addr_t is guaranteed to be u64, regardless of whether or not
the driver will run on the hardware.

[1]: https://lore.kernel.org/r/202202230559.bLOEMEUh-lkp@intel.com/
