...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF3F51E543B
	for <lists+dmaengine@lfdr.de>; Thu, 28 May 2020 04:52:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726773AbgE1Cw6 (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Wed, 27 May 2020 22:52:58 -0400
Received: from perceval.ideasonboard.com ([213.167.242.64]:58408 "EHLO
        perceval.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726770AbgE1Cw5 (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Wed, 27 May 2020 22:52:57 -0400
Received: from pendragon.bb.dnainternet.fi (81-175-216-236.bb.dnainternet.fi [81.175.216.236])
        by perceval.ideasonboard.com (Postfix) with ESMTPSA id 4BAEA521;
        Thu, 28 May 2020 04:52:53 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
        s=mail; t=1590634373;
        bh=5dkfE6gxOBrnmuXQkCJtm7lr6iI0tgboiNLbeAIUdjA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=EuRu5gN61tFKRnI25kuKNDRWFWuMwhE5owOHqal+cM9gPzFMoIveraJnDM1hIT96D
         iHb/EFuBrA6hZYe5FvA1edOfBSVOjm6/MsG+Cao3jl5pgJWpg5Vr1aoiySDdo1MXNE
         jlGKPodpcu+mupLn4j52o+3rrtAz1FbXEJHez+tk=
...
Subject: [PATCH v5 5/6] dmaengine: xilinx: dpdma: Add debugfs support
Date:   Thu, 28 May 2020 05:52:27 +0300
Message-Id: <20200528025228.31638-6-laurent.pinchart@ideasonboard.com>
...
index 227f8b083d1f..2491720e5c9d 100644
...
+
  ...
  * I/O Accessors
  */
@@ -850,6 +1074,8 @@ static void xilinx_dpdma_chan_done_irq(struct xilinx_dpdma_chan *chan)
...
@@ -1496,6 +1722,8 @@ static int xilinx_dpdma_probe(struct platform_device *pdev)
