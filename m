...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC7CA3C9465
	for <lists+dmaengine@lfdr.de>; Thu, 15 Jul 2021 01:20:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237514AbhGNXXd (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Wed, 14 Jul 2021 19:23:33 -0400
Received: from mga03.intel.com ([134.134.136.65]:18952 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S237563AbhGNXXc (ORCPT <rfc822;dmaengine@vger.kernel.org>);
        Wed, 14 Jul 2021 19:23:32 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10045"; a="210487797"
X-IronPort-AV: E=Sophos;i="5.84,240,1620716400"; 
   d="scan'208";a="210487797"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Jul 2021 16:20:40 -0700
X-IronPort-AV: E=Sophos;i="5.84,240,1620716400"; 
   d="scan'208";a="651358202"
Received: from djiang5-desk3.ch.intel.com ([143.182.136.137])
  by fmsmga006-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Jul 2021 16:20:39 -0700
Subject: [PATCH v2 03/18] dmaengine: idxd: add 'struct idxd_dev' as wrapper
 for conf_dev
From:   Dave Jiang <dave.jiang@intel.com>
To:     vkoul@kernel.org
Cc:     dmaengine@vger.kernel.org
Date:   Wed, 14 Jul 2021 16:20:39 -0700
Message-ID: <162630483962.631529.16161733492554636688.stgit@djiang5-desk3.ch.intel.com>
...
index b1e4fd202d7e..2a8327ad2984 100644
...
index 1b3ee5f5b559..ace67d31e17e 100644
--- a/drivers/dma/idxd/init.c
+++ b/drivers/dma/idxd/init.c
@@ -198,6 +198,7 @@ static int idxd_setup_wqs(struct idxd_device *idxd)
 {
...
@@ -212,15 +213,17 @@ static int idxd_setup_wqs(struct idxd_device *idxd)
 			goto err;
 		}
...
@@ -231,7 +234,7 @@ static int idxd_setup_wqs(struct idxd_device *idxd)
...
@@ -241,8 +244,11 @@ static int idxd_setup_wqs(struct idxd_device *idxd)
 	return 0;
...
@@ -250,6 +256,7 @@ static int idxd_setup_engines(struct idxd_device *idxd)
 {
...
@@ -264,15 +271,17 @@ static int idxd_setup_engines(struct idxd_device *idxd)
 			goto err;
 		}
...
@@ -282,14 +291,18 @@ static int idxd_setup_engines(struct idxd_device *idxd)
 	return 0;
...
@@ -305,15 +318,17 @@ static int idxd_setup_groups(struct idxd_device *idxd)
 			goto err;
 		}
...
@@ -325,8 +340,10 @@ static int idxd_setup_groups(struct idxd_device *idxd)
 	return 0;
...
@@ -335,11 +352,11 @@ static void idxd_cleanup_internals(struct idxd_device *idxd)
 	int i;
...
@@ -379,13 +396,13 @@ static int idxd_setup_internals(struct idxd_device *idxd)
...
+		put_device(wq_confdev(idxd->wqs[i]));
  err_wqs:
 	...
 	return rc;
@@ -467,6 +484,7 @@ static void idxd_read_caps(struct idxd_device *idxd)
...
@@ -474,19 +492,21 @@ static struct idxd_device *idxd_alloc(struct pci_dev *pdev, struct idxd_driver_d
 	if (!idxd)
 		return NULL;
...
@@ -672,7 +692,7 @@ static int idxd_pci_probe(struct pci_dev *pdev, const struct pci_device_id *id)
  err:
