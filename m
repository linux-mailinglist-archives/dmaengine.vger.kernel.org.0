Return-Path: <dmaengine+bounces-6069-lists+dmaengine=lfdr.de@vger.kernel.org>
X-Original-To: lists+dmaengine@lfdr.de
Delivered-To: lists+dmaengine@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 801F0B2C914
	for <lists+dmaengine@lfdr.de>; Tue, 19 Aug 2025 18:07:42 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 0BB801C20208
	for <lists+dmaengine@lfdr.de>; Tue, 19 Aug 2025 16:05:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D1A1523F291;
	Tue, 19 Aug 2025 16:05:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=deltatee.com header.i=@deltatee.com header.b="ZWKy+tZE"
X-Original-To: dmaengine@vger.kernel.org
Received: from ale.deltatee.com (ale.deltatee.com [204.191.154.188])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 78ABB1E47BA
	for <dmaengine@vger.kernel.org>; Tue, 19 Aug 2025 16:05:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=204.191.154.188
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1755619530; cv=none; b=a1yeuJL/VLafvdHM+PSb2s8hGx3eCjvq66RKtXwHDpGjTBz0s4z8l3K4lOy8nc1JVKJySXo964iZb1qU8CQ6qsTCDtwrALtpqCXBZYYmLWjdQ25dApOTxi29iOubZ9+KWMQnYXNzHVowcIkPOUdGSlJzI9y28OkJASBuMmgIAPo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1755619530; c=relaxed/simple;
	bh=la8PyQWBkfgrJwO3I0yt1TOj3oqPvdMiaQIOMkpHkfM=;
	h=From:To:Cc:Date:Message-Id:In-Reply-To:References:MIME-Version:
	 Subject; b=KWI60ezLLyMeSlzqPDK3KkQLVAStcF4A4bF3um5UK0fpaklWu5+jA6sATrsXnxD6IijEoURjZmdr5q+P7q399Ri3pbqpS2eCH9FTkrvOP3r1SBxnOWHh97vLKVhNd7EFBZ6P/IRnhph4eP5MLqcXyEBxfR2wf9XXAF46mbS0M0M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=deltatee.com; spf=pass smtp.mailfrom=deltatee.com; dkim=pass (2048-bit key) header.d=deltatee.com header.i=@deltatee.com header.b=ZWKy+tZE; arc=none smtp.client-ip=204.191.154.188
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=deltatee.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=deltatee.com
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	d=deltatee.com; s=20200525; h=Subject:MIME-Version:References:In-Reply-To:
	Message-Id:Date:Cc:To:From:content-disposition;
	bh=CZeCzLFLLxYuKms2Bm3SpEnyCsHrfW7rwJzXpR1D0ek=; b=ZWKy+tZE3w4IYm8qj0Ut/GoXOD
	;
...
Date: Tue, 19 Aug 2025 10:05:02 -0600
Message-Id: <20250819160503.6890-3-logang@deltatee.com>
...
X-Spam-Level: 
Subject: [PATCH v9 2/3] dmaengine: switchtec-dma: Implement hardware initialization and cleanup
