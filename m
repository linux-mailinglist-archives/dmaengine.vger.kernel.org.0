...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E08EE64D403
	for <lists+dmaengine@lfdr.de>; Thu, 15 Dec 2022 00:54:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229872AbiLNXyl (ORCPT <rfc822;lists+dmaengine@lfdr.de>);
        Wed, 14 Dec 2022 18:54:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44418 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229868AbiLNXx3 (ORCPT
        <rfc822;dmaengine@vger.kernel.org>); Wed, 14 Dec 2022 18:53:29 -0500
Received: from post.baikalelectronics.com (post.baikalelectronics.com [213.79.110.86])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id D303215FFE;
        Wed, 14 Dec 2022 15:53:26 -0800 (PST)
Received: from post.baikalelectronics.com (localhost.localdomain [127.0.0.1])
        by post.baikalelectronics.com (Proxmox) with ESMTP id 71F54E0ECE;
        Thu, 15 Dec 2022 02:53:26 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        baikalelectronics.ru; h=cc:cc:content-transfer-encoding
        :content-type:content-type:date:from:from:in-reply-to:message-id
        :mime-version:references:reply-to:subject:subject:to:to; s=post;
         bh=TsHouDSJ8LcqaqVcjDj0RaqKIF2XP1Xa+WJCgPOPLNg=; b=UGgbVQmTDBx/
        XaIzko+rCmNSd5Sc6E8gn7HfmUWAPKnqMI9d/YbRCTfQyJ6K8SIL2sVQQ2uWy4BI
        IXJrwjXuKEbK7huw/egLmPlVksSUPg8cR5tNOBxU+FqiP2cE9ePL0ep6Wo1/SqgB
        Pct27h/DyaeJgwvzXTFaUuWuzWPr3W4=
Received: from mail.baikal.int (mail.baikal.int [192.168.51.25])
        by post.baikalelectronics.com (Proxmox) with ESMTP id 62E1FE0E6B;
        Thu, 15 Dec 2022 02:53:26 +0300 (MSK)
Received: from localhost (10.8.30.6) by mail (192.168.51.25) with Microsoft
 SMTP Server (TLS) id 15.0.1395.4; Thu, 15 Dec 2022 02:53:26 +0300
...
Subject: [PATCH v7 25/25] PCI: dwc: Add DW eDMA engine support
Date:   Thu, 15 Dec 2022 02:53:05 +0300
Message-ID: <20221214235305.31744-26-Sergey.Semin@baikalelectronics.ru>
...
index f68d1ab83bb3..1a9956692a97 100644
...
@@ -768,6 +771,10 @@ int dw_pcie_ep_init(struct dw_pcie_ep *ep)
...
@@ -776,10 +783,13 @@ int dw_pcie_ep_init(struct dw_pcie_ep *ep)
...
index 1a3dae1f6aa2..4733cbdb3d6e 100644
--- a/drivers/pci/controller/dwc/pcie-designware-host.c
+++ b/drivers/pci/controller/dwc/pcie-designware-host.c
@@ -478,14 +478,18 @@ int dw_pcie_host_init(struct dw_pcie_rp *pp)
...
@@ -502,6 +506,9 @@ int dw_pcie_host_init(struct dw_pcie_rp *pp)
 err_stop_link:
...
+
 err_free_msi:
 	if (pp->has_msi_ctrl)
 		dw_pcie_free_msi(pp);
@@ -523,6 +530,8 @@ void dw_pcie_host_deinit(struct dw_pcie_rp *pp)
...
index 1e06ccf2dc9e..825cabde67a4 100644
