Return-Path: <dmaengine+bounces-9525-lists+dmaengine=lfdr.de@vger.kernel.org>
Delivered-To: lists+dmaengine@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kEO8LlcdvGlEsQIAu9opvQ
	(envelope-from <dmaengine+bounces-9525-lists+dmaengine=lfdr.de@vger.kernel.org>)
	for <lists+dmaengine@lfdr.de>; Thu, 19 Mar 2026 16:59:19 +0100
X-Original-To: lists+dmaengine@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id A492B2CE295
	for <lists+dmaengine@lfdr.de>; Thu, 19 Mar 2026 16:59:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 0BFC630340AF
	for <lists+dmaengine@lfdr.de>; Thu, 19 Mar 2026 15:56:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 281E23EAC94;
	Thu, 19 Mar 2026 15:55:17 +0000 (UTC)
X-Original-To: dmaengine@vger.kernel.org
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A22EA3E3179;
	Thu, 19 Mar 2026 15:55:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.160.252.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1773935717; cv=none; b=pdEXkn96ykP2mA+wkw9xmzokUV15mgk/+tJj2Qc6ptKBWgp6NvG2qFIcPVDeE56lNAaRKHpDLdmOEkJ3Xh4QiQSgm8mFas03VmGqFhLnAlentoRBeJnURpdfcz0Ff1ylh6T45h8sXKw45BG+EJABh8/8NnARSQYgu6OQaBUNuBg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1773935717; c=relaxed/simple;
	bh=4H5xNHQGaLEsYQIqbSLum1bdJ1kgsgD+WOf8GzjLQgM=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=VJSHmXQrLGhntKd98QUHsWmAvlP68/1HucGQDjtDHKO5bbDYBiIfVX5cCfCQbmSviuIe/b9z7W0aH6YbgWydXrreA0gCVfEziKzrqy5Bx+0KfONW/Lzo0WUUTc+BU+EgFHuB06pt8Rj804n4TSPiGTd3xzJtzecubAHIRdVWk8c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com; spf=pass smtp.mailfrom=bp.renesas.com; arc=none smtp.client-ip=210.160.252.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bp.renesas.com
X-CSE-ConnectionGUID: w02E6jskQwmn5Juqr7KHWA==
X-CSE-MsgGUID: tJFVv2+aRpiT4PUv8M4wqg==
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 20 Mar 2026 00:55:13 +0900
Received: from ubuntu.adwin.renesas.com (unknown [10.226.93.35])
	by relmlir6.idc.renesas.com (Postfix) with ESMTP id 95140401B2E9;
	Fri, 20 Mar 2026 00:55:05 +0900 (JST)
...
Subject: [PATCH 03/22] clk: renesas: r9a09g047: Add audio clock and reset support
Date: Thu, 19 Mar 2026 16:53:15 +0100
Message-ID: <20260319155334.51278-4-john.madieu.xa@bp.renesas.com>
...
X-Spamd-Result: default: False [1.64 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-9525-lists,dmaengine=lfdr.de];
...
index 1e9896742a06..3623cc5db38d 100644
...
@@ -135,6 +148,12 @@ static const struct cpg_core_clk r9a09g047_core_clks[] __initconst = {
...
@@ -142,9 +161,11 @@ static const struct cpg_core_clk r9a09g047_core_clks[] __initconst = {
...
@@ -152,7 +173,10 @@ static const struct cpg_core_clk r9a09g047_core_clks[] __initconst = {
...
@@ -164,9 +188,9 @@ static const struct cpg_core_clk r9a09g047_core_clks[] __initconst = {
...
@@ -438,6 +462,96 @@ static const struct rzv2h_mod_clk r9a09g047_mod_clks[] __initconst = {
 						BUS_MSTOP(3, BIT(4))),
...
@@ -509,6 +623,20 @@ static const struct rzv2h_reset r9a09g047_resets[] __initconst = {
